#include <stdio.h>   // Para funciones de entrada y salida estándar (printf, scanf, fopen, etc.)
#include <stdlib.h>  // Para funciones de gestión de memoria dinámica (malloc, free, exit, etc.)
#include <string.h>  // Para manejo de cadenas (strlen, strcpy, strstr, memcpy, etc.)
#include <ctype.h>   // Para funciones de manipulación de caracteres (tolower, isalpha, etc.)
